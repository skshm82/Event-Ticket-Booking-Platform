...
export default function BookingCard({ booking, onCancel, cancelling = false }) {
  ...
  return (
    <div
      ...
      className="glass-card p-5 transition-all duration-200 hover:border-surface-600"
    >
      <div className="flex flex-col sm:flex-row sm:items-start gap-4">
        ...
        <div className="flex-1 min-w-0 space-y-2">
          <div className="flex items-start justify-between gap-3">
            ...
            <span
              className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium shrink-0 ${badge.classes}`}
            >
          ...
          <div className="flex items-center gap-1.5 text-sm text-surface-400">
            ...
            <div className="flex flex-wrap gap-1">
              {booking.seatLabels.map((label) => (
                <span
                  key={label}
                  className="inline-block px-1.5 py-0.5 bg-surface-800 rounded text-xs font-mono text-surface-300"
                >
                  {label}
                </span>
              ))}
        ...
        {/* Price & Actions */}
        <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-start gap-3 sm:gap-2 sm:min-w-[120px]">
